...
import { Animated, View, Text, Dimensions, TouchableOpacity, Image, LogBox, Keyboard } from "react-native";
import { Colors, DefaultColors, Navigation, DEFAULT_USER_PICTURE, Sizes } from "../constants";
...
export default function Post({
    ...
    const [isCommentsEnabled, setCommentsEnabled] = React.useState(commentsEnabled)
            ...
            <ScrollView style={style.ScrollView}>
                ...
                <View style={style.Post.Wrapper}>
                    <DoubleClick
                        onClick={() => {
                            ...
                            setTimeout(() => {fadeOut(likeAnimation)}, 300)
                            if (!liked) {
                    ...
                    >
                        <Animated.View
                            style={[style.LikeIconAnim.Wrapper, {
                ...
                {postDescription ?
                    <View style={style.Description.Wrapper}>
                        <Text style={style.Description.Author}>
                            {authorUsername}
                        </Text>
