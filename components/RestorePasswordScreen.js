...
export default function RestorePasswordScreen({
    ...
    async function PhoneVerification() {
        ...
        // Выполняем запрос
        const json = await APIRequest.post('restore/phone/', {
    ...
    async function RestorePassword() {
        ...
        // Выполняем запрос
        const json = await APIRequest.post('restore/', {
            phone_number: phoneNumber,
            password: password,
                ...
                <DefaultAuthForm withoutLogo={true} content={(
                    <View style={s.Wrapper}>
                        ...
                        <FlatButton text={t.Button}
                            ...
                            wrapperStyle={s.Button}
                            active={isPasswordValid && isPasswordAgainValid && FieldsValidator.doPasswordsMatch(password, passwordAgain)} />
