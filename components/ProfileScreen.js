                    ...
                    <View style={s.Header}>
                        ...
                        <View style={s.Row}>
                            ...
                            <View style={s.Stats.Wrapper}>
                                <View style={s.Stats.View}>
                                    <Text style={s.Stats.Text1}>{ numberToReadableStr(me.posts_count) }</Text>
                                    <Text style={s.Stats.Text2}>{ t.Posts }</Text>
                                </View>
                                <View style={s.Stats.View}>
                                    <Text style={s.Stats.Text1}>{ numberToReadableStr(me.followers_count) }</Text>
                                    <Text style={s.Stats.Text2}>{ t.Followers }</Text>
                                </View>
                                <View style={s.Stats.View}>
                                    <Text style={s.Stats.Text1}>{ numberToReadableStr(me.followed_count) }</Text>
                                    <Text style={s.Stats.Text2}>{ t.Followed }</Text>
                                </View>
                            </View>
                        </View>
                        <View style={[s.Bio.View, {
                            ...
                            {me.bio != "" ? (
                                <Text style={s.Bio.Text}>{me.bio}</Text>
                            ) : null}
                        </View>
                        <View style={s.Buttons.Wrapper}>
                            <FlatButton
                                ...
                                wrapperStyle={Styles.ProfileButton.Wrapper}
                                buttonStyle={Styles.ProfileButton.ButtonStyle}
                                textStyle={Styles.ProfileButton.TextStyle}
                            />
                            <FlatButton
                                text={t.Buttons.Archive}
                                onPress={() => {
